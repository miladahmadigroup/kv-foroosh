...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    } elseif ($user->usernameExists($form_data['username'])) {
    ...
    // اگر خطایی نبود، کاربر را ایجاد کن
    if (empty($errors)) {
        ...
        if ($user->create($form_data)) {
            ...
            $error = 'خطا در ایجاد کاربر. لطفاً مجدداً تلاش کنید.';
        }
    } else {
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">اطلاعات کاربر جدید</h5>
                </div>
                <div class="card-body">
                    <form method="POST" id="userForm" novalidate>
                        <div class="row">
                            ...
                            <!-- نوع مشتری -->
                            <div class="col-md-6 mb-3" id="customer_type_wrapper" style="display: none;">
